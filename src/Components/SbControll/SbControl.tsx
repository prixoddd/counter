        ...
        <div className={`${e.background} ${e.overlay}`}>
            <div className={s.scoreBoard}>
                <div className={s.textInput}>
                    Max value:
                    <input type="number" className={disabledMax()} onChange={onChangeMax} value={maxValue} />
                </div>
                <div className={s.textInput}>
                    Start value:
                    <input type="number" className={disabledStart()} onChange={onChangeStart} value={startValue} />
                </div>
            </div>
